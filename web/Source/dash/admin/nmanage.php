	     ...
	     <div class="col-md-6 col-sm-12 col-xs-12">
          <div class="white-box">
				...
				<table class="table table-bordered">
						<thead>
							<tr>
								<th style="font-size: 13px;">标题</th>
								<th style="font-size: 13px;">内容</th>
								<th style="font-size: 13px;">时间</th>
								<th class="text-center" style="font-size: 13px;">删除</th>
							</tr>
						</thead>
						<tbody>
							<form method="post">
		...
		<div class="col-md-6 col-sm-12 col-xs-12">
          <div class="white-box">
				...
				<form class="form-horizontal push-10-t" method="post">
							...
							<div class="form-group">
								<div class="col-sm-9">
									<button name="addnews" value="do" class="btn btn-sm btn-primary" type="submit">添加</button>
								</div>
							</div>
						</form>
