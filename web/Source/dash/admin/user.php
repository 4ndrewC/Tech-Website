<?php
   ...
   if (isset($_POST['update'])){
	   ...
	   if ($user -> isAdmin($odb)){
			...
			if ($ban_sbp!= $_POST['ban_sbp']){
					$SQL = $odb -> prepare("UPDATE `users` SET `ban_sbp` = :username WHERE `ID` = :id");
					$SQL -> execute(array(':username' => $_POST['ban_sbp'], ':id' => $id));
					$update = true;
					$ban_sbp = $_POST['ban_sbp'];
	  ...
	  <?php
		...
		?>
	     ...
	     <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<?php if($ban_sbp!=Null){
					echo '<div class="alert alert-info">'.$ban_sbp.'</div>';
				}
				?>
								...
								<div class="form-group row">
									<div class="col-sm-12">
										<div class="form-material">
										<label for="ban_sbp">Engel Sebep</label>
											<input class="form-control" type="text" id="ban_sbp" name="ban_sbp" value="<?php echo $ban_sbp; ?>">
