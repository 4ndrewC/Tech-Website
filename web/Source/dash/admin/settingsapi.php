          ...
          <div class="white-box">
            <h3 class="box-title">Add New Method</h3>
					...
					<form class="form-horizontal push-10-t" method="post">
							...
							<div class="form-group">
								<div class="col-sm-9">
									<button name="addmethod" value="do" class="btn btn-success btn-border btn-lg w-100 fw-bold mb-3" type="submit">添加</button>
								</div>
							</div>
						</form>
          ...
          <div class="white-box">
            <h3 class="box-title">Add New Server</h3>
				<form class="form-horizontal push-10-t" method="post">
							...
							<div class="form-group">
								<div class="col-sm-12">
									...
									<label for="methods">Allowed Methods</label>
										<select class="form-control" id="methods" name="methods[]"  multiple>
											<?php
											$SQLGetMethods = $odb -> query("SELECT * FROM `methods`");
											while($getInfo = $SQLGetMethods -> fetch(PDO::FETCH_ASSOC)){
												$name = $getInfo['name'];
							...
							<div class="form-group">
								<div class="col-sm-9">
									<button name="addapi" value="do" class="btn btn-success btn-border btn-lg w-100 fw-bold mb-3" type="submit">添加</button>
								</div>
							</div>
						</form>
          </div>
