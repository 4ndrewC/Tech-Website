  ...
  <!-- Page Content -->
	  ...
	  <?php
		...
		?>
			...
			<a href="?ban=" class="btn btn-info">Tüm Üyeler</a>
			<a href="?ban=1" class="btn btn-danger">Banlı Üyeler</a>
				<table id="myTable" class="table table-striped">
							...
							<?php
							if(@$_GET["ban"]=="1"){
							$SQLGetUsers = $odb -> query("SELECT * FROM `users` where status='1' ORDER BY `ID` DESC");
							}
							else{
