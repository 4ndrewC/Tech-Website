					...
					<ul id="sidebarnav" class="in">
						...
						<li class="sidebar-item">
							<a class="sidebar-link sidebar-link" href="activate.php" aria-expanded="false">
								...
								<span class="hide-menu">卡密激活</span>
							</a>
						</li>
						<li class="sidebar-item">
				...
				<li class="list-divider"></li>
                  ...
                  <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-wifi-off feather-icon"><line x1="1" y1="1" x2="23" y2="23"></line><path d="M16.72 11.06A10.94 10.94 0 0 1 19 12.55"></path><path d="M5 12.55a10.94 10.94 0 0 1 5.17-2.39"></path><path d="M10.71 5.05A16 16 0 0 1 22.58 9"></path><path d="M1.42 9a15.91 15.91 0 0 1 4.7-2.88"></path><path d="M8.53 16.11a6 6 0 0 1 6.95 0"></path><line x1="12" y1="20" x2="12" y2="20"></line></svg><span class="hide-menu">测压面板 </span></a>
                            <ul aria-expanded="false" class="collapse first-level base-level-line">
                                <li class="sidebar-item"><a href="hub_ip.php" class="sidebar-link"><span class="hide-menu"> Layer4 (IPv4)
                                        </span></a>
                                </li>
								<li class="sidebar-item"><a href="hub_web.php" class="sidebar-link"><span class="hide-menu"> Layer7 (WEB)
                                        </span></a>
                                </li>
								                            </ul>
                        </li>
						<li class="list-divider"></li>
						<li class="nav-small-cap"><span class="hide-menu">帮助</span></li>
						<li class="sidebar-item">
							<!--<a class="sidebar-link sidebar-link" href="https://t.me/ddosgetchat" aria-expanded="false">
								...
								<span class="hide-menu">Support & Chat</span>
								<!--<span class="badge bg-primary font-12 text-white font-weight-medium badge-pill ml-2 d-lg-block d-md-none">+1</span> 11
							</a>
						</li> -->
						<li class="sidebar-item">
							<a class="sidebar-link sidebar-link" href="https://t.me/MeleGet" aria-expanded="false" target="_blank">
						...
						<li class="sidebar-item">
							<a class="sidebar-link sidebar-link" href="admin/dashboard.php" aria-expanded="false">
								...
								<span class="hide-menu">登入后台</span>
							</a>
						</li><?php  }?>
												<li class="list-divider"></li>
						<li class="sidebar-item">
							<a class="sidebar-link sidebar-link" href="logout.php" aria-expanded="false">
								...
								<span class="hide-menu">退出登入</span>
							</a>
						</li>
					</ul>
				</nav>
			...
			<div class="modal-dialog modal-dialog-scrollable" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<p>By using the Server Stress Testing services provided by Scapy.cf, you agree to be responsible for all actions and consequences..</p>
						<hr>
						<h4><u>2. Privacy</u></h4>
