...
<html>
		<div class="page-wrapper" style="display: block;">
			...
			<script src="assets/js/modal.js"></script>
				<div class="d-flex align-items-center">
					<h4 class="page-title text-truncate text-white font-weight-medium mb-0">Hub L3/L4</h4>
					<div class="ml-auto">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb m-0 p-0">
								<li class="breadcrumb-item text-sql" aria-current="page"><?php echo $sitename; ?></li>
								<li class="breadcrumb-item text-muted" aria-current="page">Hub L3/L4</li>
							</ol>
						</nav>
					</div>
				</div>
      ...
      <div class="container-fluid">
		    ...
		    <div class="form-group">
                ...
                <div class="col-md-14">
                  <input class="form-control" type="text" id="target" name="target" placeholder="127.0.0.1" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="IPv4 address of the target">
                </div>
              </div>
			  <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-14">
                  <select class="form-control" id="method" name="method" onchange="fuckingl7();">
														<optgroup data-tag="startl4" label="L4 Methods">
															<!-- <option value="ssdp">Flood - SSDP</option> -->
																<?php
                ...
                <div class="col-lg-12 text-center">
                  <button class="btn btn-primary form-control" onclick="start()" type="submit">
													<i class=""></i> 提交任务
												</button>
												<?php 
