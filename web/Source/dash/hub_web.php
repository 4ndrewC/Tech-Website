		...
		document.getElementById('current_time').textContent=finish;
				...
				<script>
		            ...
		            function start() {
			           ...
			           xmlhttp.open("GET",`includes/ajax/hub_api.php?type=startl7&host=${startt == "startl7" ? host : target}&port=80&time=${time}&method=${method}&rmethod=${rmethod}&postdata=${postdata}&cookie=${cookie}&referer=${referer}&mode=${mode}&emulation=${emulation}`,true);
			           xmlhttp.send();
